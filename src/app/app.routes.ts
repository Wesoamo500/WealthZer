...
export const routes: Routes = [
  ...
  // },
  { path: 'auth', loadComponent: () => import('./authentication/auth.page').then(m => m.AuthPage) },
{ path: 'auth/register', loadComponent: () => import('./authentication/auth.page').then(m => m.AuthPage), data: { view: 'register' } },
  // {
